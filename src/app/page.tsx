            ...
            <div className="flex items-start justify-between gap-4 border-b border-white/10 p-6">
              <div>
                ...
                <p className="mt-1 text-sm text-white/60">
                  Envie seu currículo (PDF/DOC/DOCX).
                </p>
              </div>
...
export default function Home() {
  ...
  const instagram = useMemo(() => "https://instagram.com/gustavohgomes", []);
  const linkedin = useMemo(
    () => "https://www.linkedin.com/in/gustavo-henrique-gomes-643893133/",
    []
  );
    ...
    () => [
      {
        ...
        short:
          "Responsabilidade civil, obrigações, indenizações e demandas em geral.",
        bullets: [
      ...
      },
      {
        ...
        short:
          "Estrutura societária, contratos empresariais e suporte estratégico.",
        bullets: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Descontos indevidos",
          "Cartão RMC/RCC",
          "Danos morais contra instituições financeiras",
        ],
      },
      {
        ...
        short:
          "Compra e venda, locações, regularizações e disputas imobiliárias.",
      ...
      },
      {
        ...
        short:
          "Defesa técnica e acompanhamento estratégico em investigações e processos.",
        bullets: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Falência e reorganização financeira",
        ],
      },
      {
    ...
    () => [
      {
        ...
        icon: "📌",
        short:
          "Atuação em processos judiciais com estratégia, urgência e foco em resultado.",
        bullets: [
        ...
        note:
          "Esse é o serviço mais importante do escritório: condução completa do caso do início ao resultado.",
      },
      {
      ...
      },
      {
        ...
        icon: "📝",
        short:
          "Contratos claros, robustos e alinhados ao seu objetivo (pessoal/empresarial).",
        bullets: [
      ...
      },
      {
        ...
        bullets: [
          "Estratégia de tese e linha probatória",
          "Audiências, sustentações e condução do litígio",
          "Negociação e acordos inteligentes quando viável",
        ],
      },
      {
        ...
        icon: "🏛️",
        short:
          "Defesa e acompanhamento em procedimentos administrativos e autuações.",
        bullets: [
          "Defesas e recursos em processos administrativos",
          "Protocolos, prazos e estratégias documentais",
          "Atuação em demandas perante órgãos/entidades",
        ],
      },
      {
        ...
        icon: "🔎",
        short:
          "Mapeamento de riscos e conformidade antes de negócios e contratos.",
        bullets: [
          "Levantamento de passivos e riscos",
          "Análise documental e recomendações",
          "Relatório de viabilidade e mitigação",
        ],
      },
      {
        ...
        bullets: [
          "Alterações contratuais e acordos entre sócios",
          "Organização de governança e regras internas",
      ...
      },
      {
        ...
        icon: "🕒",
        short:
          "Atendimento especial em finais de semana, feriados e período noturno para urgências.",
        bullets: [
          "Atendimento emergencial e orientações urgentes",
          "Plantão em finais de semana e feriados",
          "Atuação em situações que exigem resposta imediata",
        ],
        note:
          "Plantão sujeito à disponibilidade e natureza do caso. Atendimento sob agendamento.",
      },
    ],
    []
  );
...
useEffect(() => {
  ...
  return (
    <main className="min-h-screen bg-[#0B0F1A] text-white">
      ...
      <header className="sticky top-0 z-50 bg-[#0B0F1A]/85 backdrop-blur border-b border-white/10">
        <div className="mx-auto max-w-6xl px-6 py-4 flex items-center justify-between gap-6">
          <button
            ...
            className="relative h-10 w-[200px] shrink-0"
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-7">
            ...
            <p className="mt-4 text-white/70 leading-relaxed text-justify">
              No escritório acreditamos que o Direito deve ser claro, acessível
              e estratégico. Atuamos de forma full service, oferecendo suporte
              completo em diversas áreas, com forte presença no Direito Cível,
              Empresarial, Tributário, Bancário e Consumidor.
            </p>

            <p className="mt-4 text-white/70 leading-relaxed text-justify">
              Aqui, cada cliente é ouvido, cada caso é analisado com profundidade
              e cada estratégia é construída com responsabilidade e
              comprometimento.
            </p>

            <p className="mt-4 text-white/70 leading-relaxed text-justify">
              Advocacia com técnica. Estratégia com propósito. Atendimento com
              humanidade.
            </p>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-20">
          <div className="grid lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-8">
              ...
              <p className="mt-4 text-white/90 font- text-justify">
                Administrador e Advogado com sólida experiência no ambiente
                empresarial, o Dr. Gustavo Gomes atua com foco em desafios
                jurídicos e estratégicos de alta complexidade, buscando a
                excelência em cada caso. Sua trajetória na área empresarial lhe
                confere uma visão prática e diferenciada do mercado e da
                realidade de seus clientes.
              </p>

              <p className="mt-4 text-white/90 font- text-justify">
                Atualmente, o escritório vive uma intensa atuação em processos
                bancários, especialmente em casos de{" "}
                <span className="text-white/90 font">
                  fraudes, consignados, Cartões RMC/RCC e descontos indevidos
                </span>
                , com estratégias objetivas para cessar cobranças, recuperar
                valores e responsabilizar instituições financeiras.
              </p>
      ...
      <section id="areas" className="mx-auto max-w-6xl px-6 py-16 md:py-20">
        <div className="flex items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-3 text-sm text-white/60 max-w-2xl">
              O escritório atua de forma completa e estratégica, oferecendo
              suporte jurídico integral para pessoas físicas e jurídicas em
              demandas consultivas e contenciosas.
            </p>
          </div>

          <p className="hidden md:block text-sm text-white/60 max-w-md">
            Clique em <span className="text-white/80">Saiba +</span> para ver
            exemplos e como atuamos em cada área.
          </p>
        </div>
        ...
        <div className="mt-10 grid md:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          {/* ===== BLOCO DE DESTAQUE: FRAUDE BANCÁRIA (NOVO LAYOUT + FORM) ===== */}
{/* ===== BLOCO PREMIUM: DESCONTOS INDEVIDOS (LAYOUT ORGANIZADO + MODAL) ===== */}
<section id="bancario" className="bg-black/20 border-y border-white/10">
  <div className="mx-auto max-w-6xl px-6 py-16 md:py-20">
    {/* Header central */}
    <div className="max-w-3xl">
      ...
      <p className="mt-4 text-white/70 leading-relaxed text-justify">
        Se você está com descontos que não reconhece (consignado, cartão RMC/RCC ou
        cobranças abusivas), nossa atuação é voltada a cessar a cobrança, recuperar
        valores e responsabilizar a instituição financeira. Para agilizar, clique no
        botão e envie seu caso pronto para atendimento.
      </p>
    </div>

    {/* Conteúdo em 2 colunas equilibradas */}
    <div className="mt-10 grid lg:grid-cols-12 gap-8 items-start">
      {/* Coluna esquerda: conteúdo */}
      <div className="lg:col-span-7 space-y-6">
        {/* Cards de situações comuns */}
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          <h3 className="text-lg font-semibold">Situações comuns</h3>
          <p className="mt-2 text-sm text-white/60">
            Veja se alguma delas parece com o seu caso:
          </p>
      ...
      {/* Coluna direita: card premium + CTA */}
      <div className="lg:col-span-5">
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 sticky top-24">
          ...
          <p className="mt-2 text-sm text-white/60 leading-relaxed text-justify">
            Clique no botão abaixo e preencha 4 perguntas. Em seguida, o WhatsApp abre com
            a mensagem pronta para análise inicial.
          </p>

          {/* Steps mini (deixa o card “cheio”, organizado e premium) */}
          ...
          <div className="mt-6 rounded-xl border border-white/10 bg-black/20 p-4">
            ...
            <p className="mt-2 text-xs text-white/55 leading-relaxed text-justify">
              Se você tiver, já separe: print do extrato do benefício, tela de empréstimos/consignações
              no Meu INSS e período aproximado em que começou o desconto. Isso acelera muito a análise.
            </p>
          </div>
      ...
      {/* ===== SERVIÇOS (dinâmico) ===== */}
      <section id="servicos" className="bg-black/20 border-y border-white/10">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-20">
          <div className="flex items-end justify-between gap-6">
            <h2 className="text-3xl font-semibold">Serviços</h2>
            <p className="hidden md:block text-sm text-white/60 max-w-md">
              Clique em <span className="text-white/80">Saiba +</span> para ver
              detalhes, exemplos e quando faz sentido contratar.
            </p>
          </div>
      ...
      <section id="portal" className="bg-black/20 border-y border-white/10">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-20">
          <div className="flex items-end justify-between gap-6">
            <div>
            ...
            {postsLoading ? (
              ...
              <div className="md:col-span-3 rounded-2xl border border-white/10 bg-white/5 p-6">
                <p className="text-white/70">
                  Ainda não há conteúdos publicados. Em breve, novidades
                  aparecerão aqui.
                </p>
              </div>
            ) : (
      ...
      {/* ===== CONTATO ===== */}
      <section id="contato" className="mx-auto max-w-6xl px-6 py-16 md:py-20">
        <h2 className="text-3xl font-semibold mb-6">Contato</h2>
        <p className="text-white/70 mb-8 max-w-2xl">
          Entre em contato para agendar uma consulta ou enviar informações do seu
          caso. Atendimento sob agendamento.
        </p>
      ...
      <footer className="border-t border-white/10">
        <div className="mx-auto max-w-6xl px-6 py-12">
          <div className="grid gap-10 md:grid-cols-12">
            ...
            <div className="md:col-span-4">
              ...
              <div className="mt-4 space-y-2 text-sm text-white/70 leading-relaxed">
                <p>
                  Avenida sete de setembro nº 1175 - Fundos - Centro -
                  Araraquara/SP – CEP 14800-390
                </p>
          ...
          <div className="mt-10 border-t border-white/10 pt-6 text-xs text-white/55 flex flex-col md:flex-row items-center justify-between gap-3">
            <p>
              © 2026 Gustavo Gomes Advocacia e Consultoria Jurídica. Todos os
              direitos reservados.
            </p>
      ...
      {founderOpen && (
        <div className="fixed inset-0 z-[260] flex items-center justify-center p-5">
          <button
            ...
            type="button"
          />
          <div className="relative w-full max-w-3xl rounded-2xl border border-white/10 bg-[#0B0F1A] shadow-[0_30px_120px_rgba(0,0,0,0.7)] overflow-hidden">
            <div className="flex items-start justify-between gap-4 border-b border-white/10 p-6">
              <div>
            ...
            <div className="p-6 space-y-4 text-sm text-white/75 leading-relaxed">
              <p>
                Administrador e Advogado com sólida experiência no ambiente
                empresarial, o Dr. Gustavo Gomes atua com foco em desafios
                jurídicos e estratégicos de alta complexidade, sempre buscando a
                excelência em cada caso. Sua trajetória profissional envolve
                anos de experiência empresarial, o que lhe confere uma visão
                prática e diferenciada do mercado e da realidade de seus
                clientes.
              </p>

              <p>
                Graduado em Administração Pública pela UNESP e em Direito pela
                Universidade de Araraquara (UNIARA), Dr. Gustavo construiu sua
                formação acadêmica voltada especialmente ao ambiente empresarial
                e tributário, unindo sólido conhecimento teórico à prática
                cotidiana da gestão de negócios.
              </p>

              <p>
                Especialista em solucionar problemas complexos e em conduzir
                negociações inteligentes, atua fortemente na área Cível, com
                ênfase em Direito Bancário, Direito do Consumidor, Direito
                Empresarial e Tributário, sempre aplicando estratégias
                personalizadas que aliam técnica, visão de mercado e inovação.
              </p>

              <p>
                Dedicação, responsabilidade, empenho e comprometimento são
                marcas registradas de sua atuação. Para o Dr. Gustavo, nenhum
                resultado é tão bom que não possa ser aprimorado: a busca
                constante por evolução é o que move sua carreira.
              </p>

              <p>
                Acredita que enfrentar novos desafios é essencial para o
                crescimento pessoal e profissional. Analisa cada caso com
                profundidade, propondo soluções eficazes, seguras e sustentáveis,
                sempre com foco na proteção dos interesses de seus clientes e na
                construção de resultados concretos.
              </p>

              <p>
                Sua abordagem é baseada na escuta atenta, na transparência e no
                atendimento personalizado, características que fortalecem a
                relação de confiança e respeito com cada cliente. A família é
                seu alicerce e sua maior prioridade, valores que também permeiam
                sua vida profissional: seriedade, respeito, responsabilidade e
                busca incessante pela excelência em tudo o que se propõe a
                fazer.
              </p>

              <p className="text-white/85 font-semibold">
                Dr. Gustavo Gomes está pronto para transformar obstáculos em
                oportunidades, impulsionando segurança jurídica, eficiência e
                crescimento para pessoas e empresas que confiam em seu trabalho.
              </p>
